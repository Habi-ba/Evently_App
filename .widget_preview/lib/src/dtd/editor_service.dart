...
mixin DtdEditorService {
  ...
  Future<void> initializeEditorService(
      WidgetPreviewScaffoldDtdServices dtdServices,) async {
    ...
    dtd.onEvent(kEditorService).listen((data) {
      ...
      // the rest.
        ...
        case EditorEventKind.themeChanged:
          _editorTheme.value = ThemeChangedEvent
              .fromJson(data.data)
              .theme;
        case EditorEventKind.activeLocationChanged:
          _selectedSourceFile.value = ActiveLocationChangedEvent
              .fromJson(
            data.data,
          )
              .textDocument;
  ...
  Future<void> _updateSelectedSourceFile() async {
    ...
    if (response != null) {
      _selectedSourceFile.value = ActiveLocation
          .fromJson(
        response.result,
      )
          .textDocument;
